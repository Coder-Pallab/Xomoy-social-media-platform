    ...
    return (
        <div className='min-h-screen flex flex-col md:flex-row'>
            ...
            <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40'>
                <img src='./xomoy_logo.png' alt="Logo image" className='w-40 h-12 object-contain' />
                <div>
                    ...
                    <p className='text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md'>Connect with global community on xomoy.</p>
                </div>
