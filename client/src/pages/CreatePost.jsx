      ...
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
          ...
          <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
              ...
              <button className='text-sm bg-linear-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-puple-700 active:scale-95 transition text-white font-medium px-8 py-2 rounded-md cursor-pointer' disabled={loading} onClick={()=> toast.promise(handleSubmit, {
                loading: "uploading ...",
